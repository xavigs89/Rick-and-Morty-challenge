function CharactersTable({ characters }) {
    ...
    return (
        <section className="text-center">
          <h2 className="text-xl font-bold mb-4">Rick and Morty characters</h2>
            ...
            <tbody>
              {firstTenCharacters.map(character => (
                <tr key={character.id} className="border border-gray-300">
                  ...
                  <td className="border border-gray-300 px-4 py-2">{character.location.name}</td>
                  <td className="border border-gray-300 px-4 py-2">{character.status}</td>
                </tr>
              ))}
            </tbody>
          </table>
